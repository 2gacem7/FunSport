    ...
    <div id="ManageCommentary">
        ...
        <div class="card mt-3 mb-3 align-item-center d-flex mx-auto" style="width:90%;background-color:#f4f4f4e3">
            ...
            <div class="card-body overflow-auto mx-auto" style="width:100%;">
                <div 
                    v-for="commentary in listCommentary" v-bind:key="commentary._id">
                    <div v-if="commentary.commentary != ''" class="row mb-2 mt-2 p-2" style="width:100%;border-bottom:1px solid silver">
                        ...
                        <button class="btn btn-danger mr-2" @click="deleteCommentary(commentary._id)">Moderate
                            Commentary</button>
                    </div>
                </div>
            </div>
