...
<style>
  ...
  #csgo .card {
    overflow: auto;
    -webkit-box-shadow: 0px 0px 12px 10px rgba(194, 6, 6, 1);
    -moz-box-shadow: 0px 0px 12px 10px rgba(194, 6, 6, 1);
    box-shadow: 0px 0px 12px 10px rgba(194, 6, 6, 1);
  }
