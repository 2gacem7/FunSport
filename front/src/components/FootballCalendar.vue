<template>
  <div
    class="m-3 card"
    style="min-height: 30rem; max-height: 30rem; max-width: 50rem"
  >
      ...
      <div v-for="item in info" :key="item.id">
        <p class="text-center font-weight-bold">
          ...
          <router-link v-bind:to="'/football/' + item.match_id">
            <button class="btn btn-success justify-content-center">View</button>
          </router-link>
        </p>
