<template>
    <div class="card m-3 bg-light" style="max-height: 50rem; max-width: 40rem">
        <div class="card-header d-flex justify-content-between">
            <img :src="return_Link(infos[0].team_badge)" alt="Team badge" style="max-width: 7rem" />
                ...
                <tbody>
                    <tr v-for="player in infos[0].players" :key="player.player_key" class="w-100">
                        ...
                        <td scope="col" class="text-center row" >
                            <p><img src="../assets/soccer-field.png" style="width: 2rem; height:2rem" class="mr-1" />{{player.player_match_played}}
                            <img src="../assets/ballon.png" style="width: 1.5rem; height:1.5rem" class="mr-1"  />{{player.player_goals}}</p>
                            
                               <p> <img src="../assets/yellow-card.png" style="width: 1.5rem; height:1.5rem"  />{{player.player_yellow_cards}}
                                <img src="../assets/red-card.png" style="width: 1.5rem; height:1.5rem" class="ml-2" />{{player.player_red_cards}}</p>
                        </td>
